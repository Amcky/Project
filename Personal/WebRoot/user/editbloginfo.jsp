...
<div id="wrapper">
  <div id="container">
    <div id="scene"> <img src="<%=request.getContextPath()%>/images/scene.jpg" alt="" />
      ...
      <div id="col_right">
        ...
        <div id="sidebar">
          ...
          <ul>
        	...
        	<li><a href="user/showUserAllArticle.action">用户首页</a></li>
        	<li><a href="editbloginfo.jsp">个性化设置</a></li>
        	<li><a href="user/addArticle.jsp">写日志</a></li>
       		<li><a href="user/showPhoto.action">相册</a></li>
          </ul>
        </div>
      </div>
      <div class="clear"> </div>
