...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/css/main.css" media="all" />
...
<div id="wrapper">
  <div id="container">
    <div id="scene"> c<img src="<%=request.getContextPath()%>/images/scene.jpg" alt="" />
      ...
      <div id="menu">
        ...
        <div class="holder"> <a href="user/editbloginfo.jsp">个性化设置</a> </div>
            ...
            <div class="comment alt">
              <div class="meta"><span class="datetime">
				...
				|评论(<s:property value="#request.critiqueCounts[#sta.index]"/>)|点击(<s:property value="#art.hasread"/>)
             	|<a href="delete.action?id=<s:property value='#art.id'/>&username=<s:property value='#art.username'/>"> 删除</a>
              </span>
                <div class="clear"> </div>
              </div>
            </div>
      ...
      <div id="col_right">
        <div id="search_box">
          <form action="hello.action" method="post">
            <div>
              <input id="reg" type="text" name="reg"  />
            </div>
            <div class="button_wrapper">
              <input type="submit" id="asd" value="Search" class="button" />
            </div>
            <div class="clear"> </div>
          </form>
        </div>
        <div id="sidebar">
          <h2>页面导航</h2>
          <ul>
             <li><a href="<%=request.getContextPath()%>showAllArticle.action">博客首页</a></li>
