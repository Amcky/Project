...
public class addReverse extends ActionSupport{
	private String ip;
	...
	public String execute() throws Exception {
		...
		String zonepath = "/var/named/" + this.ip + ".zone";
		FileWriter writer = new FileWriter(namepath, true);
		writer.write(named.toStringReverse());
		writer.close();
		...
		writer.write(zone.toStringReverse());
		writer.close();
		writer = new FileWriter(zonepath,true);
		writer.close();
		System.out.println(shell.zhixing("chown root:named /var/named/"+this.ip+".zone"));
