                        ...
                        <dd class="dl_d1">
                            <a href="#">大数据<b></b></a>
                            	 <div class="erNav1" style="display:none;">
                                    <dl>                    
                                        <dd>
                                          <%--   <s:iterator value="#session.club" var="c" >   
											<a href="${ pageContext.request.contextPath }/club_findByCid.action?cid=<s:property value="#c.cid"/>"><s:property value="#c.cname"/></a> 
											 </s:iterator>   --%>
											 <a href="${ pageContext.request.contextPath }/club_findClubByCid.action?cid=4"><%-- <s:property value="#c.cname"/> --%>蓝天云</a> 
                                        </dd>
                                    </dl>
               					 </div>
                            </dd>                    
...
<div class="navInner" style="top: 124px;">
	<div class="wrap"><a href="#" class="current">社团简介<i></i></a><a href="${ pageContext.request.contextPath }/xueshuchengguo.jsp" class="">学术成果<i></i></a></div>
</div>
<div class="mainContent">
        <div class="brand01">
            <div class="wrap">
                <p id="block1" class="tit">社团简介</p>
                <p>南阳理工学院软件学院蓝天云工作室成立于2006年</p>
				<p>&nbsp;</p>
                <p>社团主攻方向:主要包括(前端开发,Javaweb,Hadoop)</p>
				<p>&nbsp;</p>
				<p>现有社团成员40余人</p>
                <p>社团指导老师:周民</p>
				<p>&nbsp;</p>
                <p>社团地点:南阳理工学院软件学院创新基地</p>
				<p>&nbsp;</p>
            </div>
            <img src="${ pageContext.request.contextPath }/images/team1.jpg" class="img" alt="社团图片">
        </div>  
    </div>
