        ...
        <div class="loginCon">
            <div class="lt">
           	...
           	用户uid:         	
                    	...
                    	<td>
                    		<span class="text">
                    			<input type="text" name="s.uid" id="txtName"/>
                    		</span>
                    	</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <span class="text">
                            	<input type="text"  name="s.title" id="txtName"/></span><b>*</b><span id="title" class="red">请输入和资源有关的内容</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text">
                                <input type="text"  name="s.source" id="txtPass"/></span><b>*</b><span id="source" class="red">请输入有效的链接地址</span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <span class="text">
                                 <input type="text"  name="s.type" id="txtPass2"/></span><b>*</b><span id="type" class="red">提示:大数据类，Java类...</span>
                        </td>
                    </tr>                
                </table>
                    <p class="btn">
                        ...
                        <a href="${ pageContext.request.contextPath }/club/usuccess.jsp" class="button"> 
                        	点击上传
                        </a>
            ...
            <div class="hot mt1" style="float:left;margin-top:60px;margin-left:0px;">
               <dl class="tbox light">
               
                <dt class='light'><strong><a href="${ pageContext.request.contextPath }/clubsource_downLoad1.action">本月热门资料</a></strong></dt>
                <dd class='light'>
                 <ul class="c1 ico2">
                  ...
                  <!-- <li class='dotline'><a title="" href="#">############</a></li>
                  <li class='dotline'><a title="" href="#">############</a></li>
                  <li class='dotline'><a title="" href="#">#############</a></li>
                  <li class='dotline'><a title="" href="#">#############</a></li>
                  <li class='dotline'><a title="" href="#">############</a></li>
