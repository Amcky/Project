...
<link href="${ pageContext.request.contextPath }/css/page.css" rel="stylesheet" type="text/css"><title>
...
<div class="nav">
            ...
            <li class="li_h2"><a href="${ pageContext.request.contextPath }/ziyuangongxiang.jsp">资料共享<i></i></a>
            	 <div class="navHover2" style="display: none;">
                    <dl>
                        ...
                        <dd>
                            <a href="${ pageContext.request.contextPath }">资料下载</a></dd>
                    </dl>
                </div>
            </li>
    ...
    <div class="indexBanner">
        <ul>           
            <li style="display:list-item;">
                <a href="#"><img src="${ pageContext.request.contextPath }/images/97.jpg" style="border-width:0px;" width="1660" height="540"></a>
            </li>       
            <li style="display: none;">
                <a href="#"><img src="${ pageContext.request.contextPath }/images/92.jpg" style="border-width:0px;" width="1660" height="540"></a>
            </li>       
            <li style="display: none;">
                <a href="#"><img src="${ pageContext.request.contextPath }/images/94.jpg" style="border-width:0px;" width="1660" height="540"></a>
            </li>      
       
        </ul>
        <dl style="margin-left: -75.5px;">           
                    <dd class="current">
                        001</dd>                
                    <dd class="">
                        011</dd>
    ...
    <div class="indexBrandLink">
 			<div class="lfont" style="font-size:20px;color:#C63;height:40px;line-height:40px;"><marquee direction="left"><img src="${ pageContext.request.contextPath }/timg.gif" style="height:40px;">蓝天云社团有最新资源，请注意查看</marquee>
            </div>
    ...
    <div class="index">
        <div class="wrap">
            <div class="indexPro">
                <p class="tit"><a href="${ pageContext.request.contextPath }/clubactive_findAllClub1.action">社团活动</a></p>
                <div class=" jcarousel-skin-tango">
                <div class="jcarousel-container jcarousel-container-horizontal" style="position: relative;display: block;">
                <div class="jcarousel-clip jcarousel-clip-horizontal" style="position: relative;">
                <ul id="mycarousel" class="jcarousel-list jcarousel-list-horizontal" style="height: 280px; overflow: hidden; position: relative; top: 0px; margin: 0px; padding: 0px; left: -2847px; width: 4042px;">
                ...
                <img title="" src="<s:property value="#list.image"/>" alt="" style="border-width:0px;" width="188" height="188"><s:property value="#list.aname"/></li>
                   	</s:iterator>
                  <!--   <li class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal" style="float: left; list-style: outside none none;" jcarouselindex="1">
                	<img title="" src="#" alt="" style="border-width:0px;" width="188" height="188">####</li>
                     <li class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal" style="float: left; list-style: outside none none;" jcarouselindex="1">
                	<img title="" src="#" alt="" style="border-width:0px;" width="188" height="188">####</li>
                     <li class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal" style="float: left; list-style: outside none none;" jcarouselindex="1">
                	<img title="" src="#" alt="" style="border-width:0px;" width="188" height="188">####</li>
...
<script src="${ pageContext.request.contextPath }/js/注册测试.js" type="text/javascript"></script>
