...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="images/school_l.ico">
    <link href="${ pageContext.request.contextPath }/css/reset.css" rel="stylesheet" type="text/css">
    <link href="${ pageContext.request.contextPath }/css/common.css" rel="stylesheet" type="text/css">
    <link href="${ pageContext.request.contextPath }/css/page.css" rel="stylesheet" type="text/css">
    <link href="${ pageContext.request.contextPath }/css/登录.css" rel="stylesheet" type="text/css">
    <title>会员登录</title>
    <style type="text/css">
        #ul li
        {
                    ...
                    <dl>
                        <dd class="dl_d1">
                            ...
                            <div class="erNav1" style="display:none;">
                                <dl>
                                    <dd>
                                        <a href="${ pageContext.request.contextPath }/clublist.jsp">蓝天云</a></dd>
                                </dl>
                            </div>
                        </dd>
                        <dd class="dl_d2">
    ...
    <div class="span12 last">
        <div class="wrap">
            <div class="main">
                ...
                <form action="${ pageContext.request.contextPath }/goIndex.action"  method="post" novalidate="novalidate">
                    <table>
                        <tbody>
                        <tr>
