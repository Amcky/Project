...
<div class="header">
    ...
    <div class="wrap">
        ...
        <div class="headerRt">
            <p class="link">
                欢迎进入软件学院创新基地社团服务平台 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <a href="${ pageContext.request.contextPath }/jsp/menu.jsp">返回首页</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[
                <a href="${ pageContext.request.contextPath }/jsp/register.jsp">注册</a>  
                <a href="${ pageContext.request.contextPath }/jsp/goIndex.action">登录</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a>联系我们</a> |
...
<div class="nav">
    ...
    <div class="wrap">
        <ul class="clearfix menutop">
            <li class="li_h "><a href="${ pageContext.request.contextPath }/jsp/menu.jsp">首页<i></i></a></li>
             <li class="li_h1"><a
...
<div class="navInner">
	<div class="wrap">
    	<a href="${ pageContext.request.contextPath }/jsp/ltyshetuan.jsp" class="">社团简介<i></i></a>
        <a href="${ pageContext.request.contextPath }/jsp/xueshuchengguo" class="current">学术成果<i></i></a>
    </div>
</div>
        ...
        <div class="history">
               <div class="wrap">
                <div class="con">
                   ...
                   <div class="img" style="margin-left:255px;margin-top:50px;"><img src="${ pageContext.request.contextPath }/images/road1.jpg" alt="这是一张图片" style="height:800px;width:600px;matgin-left:200px;"></div>  
                </div>
                <div class="list">
                    <p class="tit">
                        主要作品展示</p>
...
<script src="${ pageContext.request.contextPath }/js/lty.js" type="text/javascript"></script>
...
<script type="text/javascript">
    $(function () {	
        ...
        lty.login();
        lty.memberIndex();
        lty.memberEventDetail();
        lty.memberPromo();
        lty.memberPromoDetail();
        lty.newsIndex();
        lty.productIndex();
        lty.product();
        lty.star();
...
<div id="topcontrol" style="position: fixed; bottom: 80px; right: 30px; opacity: 0; cursor: pointer;" title="返回顶部">
         <img src="${ pageContext.request.contextPath }/imags/goToTop.png" style="width:51px; height:40px; border:0;z-index:999;">
</div>
</body>
</html>